...
function create ()
{
    ...
    ground = this.add.tileSprite(0,H-40,W,128,'ground');
    ...
    for(let i=-10;i<=10;i++){
        let ray = this.add.sprite(W/2,H-30,'ray');
    ...
    platforms.create(430,260,'ground').setScale(1.5,0.3).refreshBody();
    platforms.create(700,90,'ground').setScale(1.5,0.3).refreshBody();
    platforms.create(90,130,'ground').setScale(1.5,0.3).refreshBody();
